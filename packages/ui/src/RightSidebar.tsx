    ...
    return (
        <aside className="md:flex flex-col gap-4 w-64 p-3">
            <div>
                ...
                {friends.map((f) => (
                    <div key={f.name} className="flex items-center gap-2 py-1 hover:bg-gray-100 hover:text-black rounded-md px-2">
            ...
            <div className="text-black">
                ...
                <div className="flex items-center gap-3 bg-white rounded-lg p-2 shadow-sm">
                    <img src="https://i.pravatar.cc/40?img=6" className="w-8 h-8 rounded-full" />
